...
function Home() {
  return (
    ...
    >
      <h1 className="w-3/4 text-center text-4xl font-bold md:text-7xl">
        I'm{" "}
      ...
      <p className="w-3/5 text-center text-2xl leading-10">
      ...
      <div className="flex items-center gap-12 text-white text-2xl font-medium mt-10">
